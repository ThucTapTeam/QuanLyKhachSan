...
--them dich vu
create proc PROC_INSERT_THEMDV @MADICHVU VARCHAR(10),@TENDICHVU NVARCHAR(30),@SOLUONG INT,@GIATIEN INT
AS
BEGIN
	INSERT INTO DICHVU VALUES(@MADICHVU,@TENDICHVU,@SOLUONG,@GIATIEN)
END
...
INSERT INTO DICHVU VALUE('DV1111',''